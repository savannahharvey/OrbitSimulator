...
class GPSRight : public SpaceObject
{
public:
   ...
   // Constructors
   GPSRight(const SpaceObject& parent, const Angle& direction) : SpaceObject(parent, direction)
   {
      this->age = 0;
   ...
   // Draw
   void draw(ogstream& gout) override { gout.drawGPSRight(pos, direction.getRadians()); }
};
