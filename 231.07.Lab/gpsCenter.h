...
class GPSCenter : public SpaceObject
{
public:
   ...
   // Constructors
   GPSCenter(const SpaceObject& parent, const Angle& direction) : SpaceObject(parent, direction)
   {
      this->age = 0;
   ...
   // Draw
   void draw(ogstream& gout) override { gout.drawGPSCenter(pos, direction.getRadians()); }
};
