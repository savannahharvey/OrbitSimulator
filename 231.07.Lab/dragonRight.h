...
class DragonRight : public SpaceObject
{
public:
   friend TestSatellite;

   // Constructors
   DragonRight(const SpaceObject& parent, const Angle& direction) : SpaceObject(parent, direction)
   {
      this->age = 0;
...
//      this->fragments = 3;
   ...
   // Draw
   void draw(ogstream& gout) override { gout.drawCrewDragonRight(pos, direction.getRadians()); }
