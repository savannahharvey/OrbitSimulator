...
class DragonLeft : public SpaceObject
{
public:
   friend TestSatellite;

   // Constructors
   DragonLeft(const SpaceObject& parent, const Angle& direction) : SpaceObject(parent, direction)
   {
      this->age = 0;
...
//      this->fragments = 3;
   ...
   // Draw
   void draw(ogstream& gout) override { gout.drawCrewDragonLeft(pos, direction.getRadians()); }
