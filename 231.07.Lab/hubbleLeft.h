/***********************************************************************
 * Header File:
 *    HubbleLeft : A Global Positioning System satellite from way back in the 70s
 * Author:
...
class HubbleLeft : public SpaceObject
{
public:
   ...
   // Constructors
   HubbleLeft(const SpaceObject& parent, const Angle& direction) : SpaceObject(parent, direction)
   {
      this->age = 0;
