/***********************************************************************
 * Header File:
 *    Starlink Array : Part of SpaceX Starlink.
 * Author:
...
class StarlinkArray : public SpaceObject
{
public:
   friend TestSatellite;

   // Constructors
   StarlinkArray(const SpaceObject& parent, const Angle& direction) : SpaceObject(parent, direction)
   {
      this->age = 0;
...
//      this->fragments = 3;
   ...
   // Draw
   void draw(ogstream& gout) override { gout.drawStarlinkArray(pos, direction.getRadians()); }
